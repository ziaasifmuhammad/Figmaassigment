...
const DiscountSofa = () => {
  return (
    <div className="px-4">
      <h1 className="text-center text-2xl sm:text-4xl font-bold  text-blue-800 mt-4">Discount Item</h1>
      <ul className="flex flex-wrap justify-center space-x-4 sm:space-x-10 mt-4">
        <li>
          <a href="/" className="hover:text-red-500 text-sm sm:text-base">
            Wooden Chair
          </a>
        </li>
        <li>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center lg:min-h-screen lg:px-6 mt-8 lg:mt-0 space-y-6 lg:space-y-0">
        ...
        <div className="lg:w-1/2 px-4 lg:px-8 text-center lg:text-left">
          <h1 className="text-xl sm:text-3xl font-bold text-blue-800 mb-4">20% Discount Of All Products</h1>
