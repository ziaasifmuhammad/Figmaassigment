...
const Product = () => {
    return (
        <div>
<h1 className="text-center text-blue-800 justify-center text-5xl">Leatest Products</h1>
<ul className="flex  ml-11 pt-3 items-center justify-center  align-bottom space-x-10">
                  <li> <a href="/" className="hover:text-red-500">New Arrival</a> </li>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div className="bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        />
        <div className="flex  gap-11 mt-11 pl-4">
          <h2 className="text-xs  text-center justify-evenly font-bold mb-2">Comfort Handy Craft</h2>
          <p className="text-gray-600 text-center justify-center">$ 42.00</p>
        </div>
      </div>
